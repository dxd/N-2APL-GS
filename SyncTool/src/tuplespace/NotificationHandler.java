...
public class NotificationHandler extends UnicastRemoteObject implements RemoteEventListener {
	...
	public synchronized void notify(RemoteEvent anEvent) {
        ...
        try {
        	...
        	System.out.println("game notification: "+e);
        	synchro.postUpdate(e);
        	...
        	//r = synchro.jspace.readUpdate(e, timestamps.get(pair) != null?timestamps.get(pair):new Timestamp(0),newTime);
