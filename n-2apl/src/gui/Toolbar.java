...
public class Toolbar implements ActionListener, ItemListener
{
	...
	public Toolbar(GUI gui)
	{
		...
		toolbar.addSeparator(sep);
		addButton("message.png", "Start message subject");
		toolbar.addSeparator(sep);
		...
		addMenuItem(debug, "Message Agent", "Launch Message subject",
				"message.png", -1);
		menubar.add(debug);
	...
	/**
	 * Dispatches command for the multi-subject system. Commands are executed in
	 * an asynchronous fashion, i.e. method does not wait for deliberation step
	 * to finish and returns immediately.
	 * 
	 * @param action action to be performed on the multi-subject system.
	 * @param forAll flag specifying if the action is perfomed with respect to
	 *        the individual module or whole multi-subject system.
	...
	public void showAboutWindow()
	{
		...
		JLabel line1 = new JLabel(
				"This platform facilitates the development of multi-subject systems");
