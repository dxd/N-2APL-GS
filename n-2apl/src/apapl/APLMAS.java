...
/**
 * Implements the 2APL multi-subject system (MAS). The MAS keeps track of all the
 ...
 * the functionality to execute a multi-subject system. The specific strategy by
...
public class APLMAS implements MessageListener {
    ...
    public void attachModuleToEnvironment(APLModule module, String envName,
        ...
        try {   
             ...
             * Creates an entity for each subject, which is then automatically
            ...
            throw new RuntimeException("Failed to register subject " 
    ...
    public void detachModuleFromEnvironment(APLModule module, String envName) {
        try {
            ...
            throw new RuntimeException("Failed to de-register subject " 
