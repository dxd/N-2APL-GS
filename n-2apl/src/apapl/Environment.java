 ...
 * subject. It is up to the concrete environment implementation to decide whether
 * modules of one subject will be presented separately or as one entity.
 * <p />
...
public class Environment implements EnvironmentInterfaceStandard {
     ...
     * an subject enters the environment. Note that this method is also invoked each
     * time an subject is re-compiled.
     * 
     * @param name the local name of the specific subject.
     */
    protected void addAgent(String name) {
    };

    /**
     * This method is invoked when an subject operating in this environment is
     * removed. Note that this method is also invoked when an subject is
     * recompiled.
     * 
     * @param name the local name of the specific subject.
     */
     ...
     * @param receivers the subject listed to receive the event. If no
    ...
    /**
     * Creates a new EIS entity corresponding to a 2APL environment subject.
     * Associates the EIS entity with the EIS subject of the same name. This
     * function enforces the one to one - EIS subject to EIS entity - relation,
     * which is needed to fit the framework used in 2APL environments.
     * 
     * @param subject both name of the EIS entity to be added and the name of EIS
     *        subject to associate the entity with
     */
    ...
    /**
     * Deletes EIS entity corresponding to EIS subject. 
     * 
     * @param subject the name of EIS entity to be removed  
     */
    ...
    /**
     * This is a list of entities, that are not associated with any subject.
     */
    ...
    /**
     * Stores for each subject (represented by a string) a set of listeners.
     */
    ...
    /**
     * Sends a percept to an subject/several agents via a given array of entities.
     * 
     * @param percept
     * @param entity
     * @throws EnvironmentInterfaceException
    ...
    protected final void addEntity(String entity) throws EntityException {
        ...
        // Adding an entity to EIS corresponds to adding an subject in a 2APL
        // environment
        addAgent(entity);
     ...
     * disassociating it from the respective subject.
     * 
     * @param entity the id of the entity that is to be removed.
     * @throws PlatformException if the subject does not exist.
     */
    ...
    protected final void deleteEntity(String entity) throws EntityException {
        ...
        // Removing an entity in EIS corresponds to removing subject in a 2APL
        // environment
        removeAgent(entity);
     ...
     * 2APL environment subject of the same name. In order to comply to the
            ...
            for (String entity : entities) {
                if (associatedEntities.contains(entity) == false)
                    throw new ActException("Entity \"" + entity
                            + "\" is not associated to subject \"" + agent
                            + "\".");
    ...
    public final LinkedList<Percept> getAllPercepts(String agent,
        ...
        // fail if ther subject is not registered
        if (registeredAgents.contains(agent) == false)
            ...
            for (String entity : entities) {
                ...
                if (associatedEntities.contains(entity) == false)
                    throw new PerceiveException("Entity \"" + entity
                            + "\" has not been associated with the subject \""
                            + agent + "\".");
